...
//
//class UserEndpointsSpec extends AnyFunSpec with Matchers with ScalaCheckPropertyChecks with Http4sDsl[IO] with Http4sClientDsl[IO] with LoginTest {
//
...
//      val endpoint: HttpRoutes[IO] = UserEndpoints.endpoints[IO](service)
