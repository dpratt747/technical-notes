...
//
//final class UserEndpoints[F[_] : Sync] extends Http4sDsl[F] with Middleware[F] with Codec {
//
...
//  }
//
//  private def endpoints(notesService: NoteService[F]): HttpRoutes[F] = {
//    validateMandatoryHeaders(postNote(notesService), mandatoryHeaders)
//  }
//}
//
//object UserEndpoints {
//  final def endpoints[F[_] : Sync](userService: UserService): HttpRoutes[F] =
//    new UserEndpoints[F].endpoints(userService: UserService)
//}